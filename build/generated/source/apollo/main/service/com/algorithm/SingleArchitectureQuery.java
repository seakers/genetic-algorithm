...
public final class SingleArchitectureQuery implements Query<SingleArchitectureQuery.Data, SingleArchitectureQuery.Data, SingleArchitectureQuery.Variables> {
  public static final String OPERATION_ID = "671056729e23ac3c2810b7a2d37164f613b07e04436e19d43fa8e40a0edcfd99";

  public static final String QUERY_DOCUMENT = QueryDocumentMinifier.minify(
    "query SingleArchitecture($problem_id: Int!, $input: String!) {\n"
        + "  items: Architecture(where: {problem_id: {_eq: $problem_id}, input: {_eq: $input}}) {\n"
        + "    __typename\n"
        + "    id\n"
        + "    input\n"
        + "    science\n"
  ...
  private final SingleArchitectureQuery.Variables variables;

  public SingleArchitectureQuery(int problem_id, @NotNull String input) {
    Utils.checkNotNull(input, "input == null");
    variables = new SingleArchitectureQuery.Variables(problem_id, input);
  }
  ...
  @Override
  public SingleArchitectureQuery.Data wrapData(SingleArchitectureQuery.Data data) {
    return data;
  }

  @Override
  public SingleArchitectureQuery.Variables variables() {
    return variables;
  }

  @Override
  public ResponseFieldMapper<SingleArchitectureQuery.Data> responseFieldMapper() {
  ...
  @Override
  @NotNull
  public Response<SingleArchitectureQuery.Data> parse(@NotNull final BufferedSource source,
  ...
  @Override
  @NotNull
  public Response<SingleArchitectureQuery.Data> parse(@NotNull final ByteString byteString,
      @NotNull final ScalarTypeAdapters scalarTypeAdapters) throws IOException {
  ...
  @Override
  @NotNull
  public Response<SingleArchitectureQuery.Data> parse(@NotNull final BufferedSource source) throws
      IOException {
  ...
  @Override
  @NotNull
  public Response<SingleArchitectureQuery.Data> parse(@NotNull final ByteString byteString) throws
      IOException {
  ...
  public static final class Builder {
    ...
    public SingleArchitectureQuery build() {
      Utils.checkNotNull(input, "input == null");
      return new SingleArchitectureQuery(problem_id, input);
    }
  }
